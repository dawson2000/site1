		...
		<ul class="items">
			...
			?>
				...
				<div class="banner">
					<div class="asd">
						<div class="top">
							<a href="index.php?main_page=redirect&action=banner&goto=1" class="ttl">Shun Classic</a>
							<span>7 1/2" Double Hollow-Ground Sumo Santoku</span>
						</div>
					</div>
				</div>
			<?php
			...
			?>
						...
						<div class="banner">
							<div class="asd">
								<div class="top">
									<a href="index.php?main_page=redirect&action=banner&goto=2" class="ttl">All-Clad</a>
									<span>Stainless-Steel 3-Piece Mixing Bowl Set</span>
								</div>
							</div>
						</div>
			<?php 
			...
			?>
						...
						<div class="banner">
							<div class="asd">
								<div class="top">
									<a href="index.php?main_page=redirect&action=banner&goto=3" class="ttl">All-Clad</a>
									<span>Tri-Ply Stainless-Steel 4-Quart Chef's Pan</span>
								</div>
							</div>
						</div>
			<?php 
...
<div class="wrapper banner-middle">
	<div class="left-cont-banners">
	<?php		
